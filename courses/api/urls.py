...
urlpatterns = [
    ...
    path('courses/<int:course_pk>/modules/<int:module_pk>/', views.ModuleDetailView.as_view(), name='module_list'),
    ...
    path('tasks/<int:task_id>/answers/', views.StudentAnswerCreateAPIView.as_view(), name='student_answer_create'),
